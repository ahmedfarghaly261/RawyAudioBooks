...
function Footer() {
    ...
    return (
        <>
            <footer class="w-full bg-[#f4eae4] lg:px-5">
                <div class="mx-auto max-w-7xl">
                    ...
                    <div class="grid grid-cols-2 lg:grid-cols-4 2xl:grid-cols-6 gap-8 py-10 ">
                        ...
                        <div class="lg:mx-auto text-left">
                            ...
                            <ul class="text-sm  transition-all duration-500 ">
                                <li class="mb-6">
                                    <a href="javascript:;" class="text-gray-600 hover:text-gray-900">About us</a>
                                </li>
                                <li class="mb-6">
                                    <a href="javascript:;" class=" text-gray-600 hover:text-gray-900">Contact us</a>
                                </li>
                                <li class="mb-6">
                                    <a href="javascript:;" class=" text-gray-600 hover:text-gray-900">Products</a>
                                </li>
                                <li>
                                    <a href="javascript:;" class=" text-gray-600 hover:text-gray-900">Login</a>
                                </li>
                            </ul>
                        </div>
                        {/* <!--End Col--> */}
                        <div class="lg:mx-auto text-left">
                            <h4 class="text-lg text-gray-900 font-medium mb-7">Customer Area
                            </h4>
                            <ul class="text-sm  transition-all duration-500">
                                <li class="mb-6">
                                    <a href="javascript:;" class="text-gray-600 hover:text-gray-900">My Account</a>
                                </li>
                                <li class="mb-6">
                                    <a href="javascript:;" class=" text-gray-600 hover:text-gray-900">Tracking List</a>
                                </li>
                                <li class="mb-6">
                                    <a href="javascript:;" class=" text-gray-600 hover:text-gray-900">Terms</a>
                                </li>
                                <li>
                                    <a href="javascript:;" class=" text-gray-600 hover:text-gray-900">Privacy Policy</a>
                                </li>
                                <li>
                                    <a href="javascript:;" class=" text-gray-600 hover:text-gray-900">FAQ</a>
                                </li>
                            </ul>
                        </div>
                        {/* <!--End Col--> */}
                        <div class="lg:mx-auto text-left  ">
                            <h4 class="text-xl text-gray-900 font-medium mb-7">Policies</h4>
                            <ul class="text-sm  transition-all duration-500">
                                <li class="mb-6">
                                    <a href="javascript:;" class="text-gray-600 hover:text-gray-900">Privacy statement</a>
                                </li>
                                <li class="mb-6">
                                    <a href="javascript:;" class=" text-gray-600 hover:text-gray-900">Cookies</a>
                                </li>
                                <li class="mb-6">
                                    <a href="javascript:;" class=" text-gray-600 hover:text-gray-900">Supplier code of conduct</a>
                                </li>
                    ...
                    {/* <!--Grid--> */}
                    <div class="py-7 px-2 border-t border-gray-200 w-[110%]  sm:px-5 ">
