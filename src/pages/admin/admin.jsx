    ...
    return (
        ...
        <>
            <main className="flex flex-row ">
                ...
                <section className="flex-1 px-4 py-6 overflow-x-auto">
                                ...
                                <table className="min-w-full divide-y divide-gray-200 text-sm">
                                    <thead className="bg-gray-50">
                                        <tr>
                                            ...
                                            <th className="px-4 py-3.5 text-left text-gray-500 font-medium">Teams</th>
                                        ...
                                        <tr>
                                            ...
                                            <td className="px-4 py-4 whitespace-nowrap">
                                                <div className="flex flex-wrap gap-1">
                                                    <span className="bg-indigo-100 text-indigo-600 text-xs px-3 py-1 rounded-full">Design</span>
                                                    <span className="bg-blue-100 text-blue-600 text-xs px-3 py-1 rounded-full">Product</span>
                                                    <span className="bg-pink-100 text-pink-600 text-xs px-3 py-1 rounded-full">Marketing</span>
                                                </div>
                                            </td>
                                            <td className="px-4 py-4 whitespace-nowrap">
