                ...
                <table className="min-w-full divide-y divide-gray-200 text-sm">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-4 py-3.5 text-left text-gray-500 font-medium">Role</th>
                      <th className="px-4 py-3.5 text-left text-gray-500 font-medium">Email</th>
                      <th className="px-4 py-3.5 text-left text-gray-500 font-medium">profile</th>
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    <tr>
                      <td className="px-4 py-4 whitespace-nowrap text-gray-700 font-medium">
                        <div className="flex items-center gap-x-3">
                          ...
                          <div className="flex items-center gap-x-2">
                            ...
                            />
                            <div>
                              <h2 className="text-gray-800 font-semibold">Arthur Melo</h2>
                              <p className="text-gray-500 text-sm">@authurmelo</p>
                            </div>
                          </div>
                      ...
                      <td className="px-4 py-4 whitespace-nowrap text-gray-500">Design Director</td>
                      <td className="px-4 py-4 whitespace-nowrap text-gray-500">authurmelo@example.com</td>
                      <td className="px-4 py-4 whitespace-nowrap">
                        <div className="flex flex-wrap gap-1">
                          <span className="bg-indigo-100 text-indigo-600 text-xs px-3 py-1 rounded-full">profile</span>
                      ...
                      <td className="px-4 py-4 whitespace-nowrap">
                        <div className="flex gap-4">
                          ...
                          <button className="text-gray-500 hover:text-yellow-500 text-2xl">
                            <FaEdit />
                          </button>
                        </div>
                      </td>
              ...
              <div class="min-w-full inline-block align-middle">
                ...
                <div class="overflow-hidden ">
                  <table class=" min-w-full rounded-xl">
                    <thead>
                      <tr class="bg-gray-50">
                        <th scope="col" class="p-5 text-left text-sm leading-6 font-semibold text-gray-900 capitalize rounded-t-xl"> Book Name </th>
                        <th scope="col" class="p-5 text-left text-sm leading-6 font-semibold text-gray-900 capitalize"> Book ID </th>
                        <th scope="col" class="p-5 text-left text-sm leading-6 font-semibold text-gray-900 capitalize"> Type </th>
                        <th scope="col" class="p-5 text-left text-sm leading-6 font-semibold text-gray-900 capitalize"> writer </th>
                    ...
                    <tbody class="divide-y divide-gray-300 ">
                      <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                        <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 "> book1</td>
                        <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> 20010510 </td>
                        <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> romantic</td>
                        <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> name1</td>
                        <td class=" p-5 ">
